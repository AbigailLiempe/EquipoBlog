...
from Empleado.forms import EquipoFormulario, LiderFormulario, RegistroFormulario, AvatarFormulario
from Empleado.models import Equipo, Lider, Avatar, Colaborador
